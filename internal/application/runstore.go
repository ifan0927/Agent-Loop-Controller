...
type RunInspection struct {
	...
	GitHubEvidenceTotal     int                                  `json:"-"`
	GitHubEvidenceTruncated bool                                 `json:"-"`
	GitHubFeedbackEvidence  map[string]domain.GitHubReadEvidence `json:"-"`
	CIWaits                 []CIWaitEvidence                     `json:"ci_waits"`
}

const GitHubEvidenceProjectionLimit = 100
