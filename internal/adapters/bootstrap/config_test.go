...
func writeFixture(t *testing.T, root, profileID string, appID int64) (string, string) {
	...
	github := map[string]any{"api_base_url": "https://api.github.com", "graphql_url": "https://api.github.com/graphql", "app_id": appID, "installation_id": 8, "repository_owner": "owner", "repository_name": "repo", "repository_id": 9, "private_key_file": secretPath, "http_timeout": "2s", "token_refresh_skew": "5m", "api_version": "2022-11-28", "coderabbit_actor_id": 0, "coderabbit_node_id": "", "coderabbit_app_id": 0}
