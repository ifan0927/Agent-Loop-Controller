...
- local binary upgrade snapshot, replacement intent/effect/commit, rollback
  ...
  supersession and its generic-pending/malformed negative matrix, recovery intent,
  ...
  and recovery-evidence retention.
